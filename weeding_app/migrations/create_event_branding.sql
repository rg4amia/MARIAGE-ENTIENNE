-- =====================================================
-- Migration: Création de la table event_branding
-- Exécuter dans: Supabase Dashboard > SQL Editor
-- =====================================================

-- 1. Créer la table event_branding
...
-- 2. Insérer les données par défaut pour les événements existants
...
-- 3. Créer le trigger pour auto-créer le branding lors de la création d'un événement
...
-- 4. Créer le trigger pour sync les couleurs en majuscules
...
-- 6. Politique de lecture pour les membres de l'événement
...
-- 7. Politique de modification pour les managers
...
-- SELECT * FROM public.event_branding;
-- =====================================================

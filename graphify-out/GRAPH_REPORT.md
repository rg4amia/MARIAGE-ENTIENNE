...
## Corpus Check
- 197 files · ~520,321 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2230 nodes · 3058 edges · 136 communities (123 shown, 13 thin omitted)
...
- workspace_onboarding_page.dart
- FlutterActivity
- weeding_app
- AGENTS.md
- sw.js
...
Cohesion: 0.05
Nodes (43): package:intl/date_symbol_data_local.dart, package:intl/intl.dart, ScrollController, static const int, build, _buildTextField, _buildWeddingInfoCard, colors (+35 more)
...
Cohesion: 0.04
Nodes (48): Future, _assign, _availableChairs, build, _buildChairsError, _buildChairsGrid, _buildDetailRow, _buildEmptyChairs (+40 more)
...
Cohesion: 0.06
Nodes (32): ../../data/models/guest_media.dart, ../../data/repositories/media_repository.dart, MaterialPageRoute, media_player_page.dart, build, color, count, createState (+24 more)

### Community 10 - "micro_interactions.dart"
Cohesion: 0.07
Nodes (30): _anim, backgroundColor, borderRadius, boxShadow, build, child, createState, _ctrl (+22 more)
...
Cohesion: 0.05
Nodes (44): @immutable, WeddingPalette, _accentController, _backgroundController, bodyFont, build, color, _ColorSlot (+36 more)

### Community 15 - "home_page.dart"
Cohesion: 0.07
Nodes (27): ../navigation/main_navigation_controller.dart, ../subscription/subscription_banner.dart, build, _buildBody, _buildInvitationStatus, _buildKpiRow, _buildQuickActions, _buildWeddingHeader (+19 more)
...
Cohesion: 0.07
Nodes (30): ../../data/models/guest_link.dart, _AssignSheet, _AssignSheetState, availableChairs, build, _confirmCancellation, _confirmDelete, controller (+22 more)

### Community 18 - "guests_controller.dart"
Cohesion: 0.07
Nodes (27): ../../data/models/guest_seat.dart, assignSeatToGuest, cancelledCount, confirmedCount, createGuest, declinedCount, deleteGuest, filterStatus (+19 more)

### Community 19 - "State"
Cohesion: 0.10
Nodes (32): _PasswordField, SingleTickerProviderStateMixin, State, StatefulWidget, FadeInSlide, _FadeInSlideState, ScaleIn, _ScaleInState (+24 more)
...
Cohesion: 0.08
Nodes (26): Animation, Duration, Offset, TextStyle?, _anim, AnimatedCounter, _AnimatedCounterState, borderRadius (+18 more)
...
Cohesion: 0.11
Nodes (18): AnimationController, ../../core/utils/validators.dart, _bgCtrl, build, _buildInput, _buildLabel, controller, createState (+10 more)
...
Cohesion: 0.04
Nodes (36): package:flutter_test/flutter_test.dart, package:weeding_app/app/core/theme/app_colors.dart, package:weeding_app/app/core/theme/app_theme.dart, package:weeding_app/app/core/theme/wedding_palette.dart, package:weeding_app/app/core/utils/quota_error.dart, package:weeding_app/app/core/utils/validators.dart, package:weeding_app/app/data/models/chair.dart, package:weeding_app/app/data/models/entrance_qr.dart (+28 more)

### Community 29 - "guests_page.dart"
Cohesion: 0.07
Nodes (26): ../../core/utils/whatsapp_helper.dart, ../../core/widgets/shared_components.dart, _avatarColor, build, _buildField, _buildFilterChips, controller, createState (+18 more)
...
Cohesion: 0.09
Nodes (23): StatelessWidget, _GuestStatusCard, _MediaInfo, _MiniStat, _StatCard, _StatusStep, _AudioWaveform, _ControlButton (+15 more)
...
Cohesion: 0.14
Nodes (13): IconData, micro_interactions.dart, build, child, gradientColors, HeaderInfoBanner, icon, onBackPressed (+5 more)
...
Cohesion: 0.06
Nodes (32): ../../data/models/event_venue.dart, package:url_launcher/url_launcher.dart, TextEditingController, TextInputType?, venues_controller.dart, https, launchUrl, launchVenueMap (+24 more)
...
Cohesion: 0.22
Nodes (7): guest_access_controller.dart, home_controller.dart, package:get/get.dart, dependencies, GuestAccessBinding, GuestAccessController, dependencies
...
Cohesion: 0.07
Nodes (27): app_routes.dart, ../modules/admin/admin_console_page.dart, ../modules/auth/auth_binding.dart, ../modules/auth/login_page.dart, ../modules/auth/register_page.dart, ../modules/guests/guest_detail_page.dart, ../modules/guests/guests_binding.dart, ../modules/invitations/entrance_qr_page.dart (+19 more)
...
Cohesion: 0.13
Nodes (14): dart:math, ../models/guest_link.dart, package:flutter/foundation.dart, _client, createGuestLink, _fetchLinkByGuestId, _generateShortCode, getAllLinks (+6 more)
...
Cohesion: 0.13
Nodes (14): ../../data/repositories/auth_repository.dart, Rxn, brideNameController, createWorkspace, eventDate, eventTitleController, groomNameController, isLoading (+6 more)
...
Cohesion: 0.13
Nodes (14): dart:async, LocalStorage, package:flutter_secure_storage/flutter_secure_storage.dart, package:shared_preferences/shared_preferences.dart, SharedPreferences?, accessToken, hasAccessToken, initialize (+6 more)
...
### Community 79 - "workspace_onboarding_page.dart"
Cohesion: 0.13
Nodes (14): ../auth/auth_controller.dart, ../../core/widgets/micro_interactions.dart, dependencies, WorkspaceOnboardingBinding, WorkspaceOnboardingController, build, child, _pickDate (+6 more)

### Community 84 - "wedding_palette.dart"
Cohesion: 0.08
Nodes (23): int? get, accent, background, body, bodyFont, celestialRomance, colorFromHex, colorToHex (+15 more)
...
Cohesion: 0.08
Nodes (22): app/bindings/app_binding.dart, app/core/constants/supabase_config.dart, app/core/storage/secure_local_storage.dart, app/core/theme/app_theme.dart, app/core/theme/wedding_theme_controller.dart, app/routes/app_pages.dart, package:flutter_dotenv/flutter_dotenv.dart, package:flutter_localizations/flutter_localizations.dart (+14 more)
...
### Community 102 - "admin_console_page.dart"
Cohesion: 0.08
Nodes (23): admin_controller.dart, _AccountsTab, actions, AdminConsolePage, _Badge, build, _Card, _changePlan (+15 more)

### Community 103 - "app_binding.dart"
Cohesion: 0.20
Nodes (9): ../modules/admin/admin_controller.dart, ../modules/auth/auth_controller.dart, ../modules/guests/guests_controller.dart, ../modules/home/home_controller.dart, ../modules/invitations/invitations_controller.dart, ../modules/navigation/main_navigation_controller.dart, ../modules/subscription/subscription_controller.dart, ../modules/tables/tables_controller.dart (+1 more)

### Community 104 - "Bindings"
Cohesion: 0.17
Nodes (10): auth_controller.dart, Bindings, guests_controller.dart, AppBinding, AuthBinding, dependencies, dependencies, GuestsBinding (+2 more)

### Community 105 - "plans_page.dart"
Cohesion: 0.09
Nodes (22): ../../data/models/subscription.dart, ../../routes/app_routes.dart, subscription_controller.dart, SubscriptionPlan, build, isCurrent, label, plan (+14 more)

### Community 106 - "whatsapp_helper.dart"
Cohesion: 0.09
Nodes (22): ../constants/supabase_config.dart, ../../data/repositories/wedding_settings_repository.dart, return, bride, buffer, _buildInvitationMessage, date, digits (+14 more)
...
### Community 108 - "../../core/theme/app_text_styles.dart"
Cohesion: 0.12
Nodes (16): ../../core/theme/app_text_styles.dart, ../../core/widgets/animated_widgets.dart, ../../core/widgets/wedding_rings_icon.dart, build, createState, initState, _minimumDisplay, _route (+8 more)
...
Cohesion: 0.13
Nodes (14): ../../data/repositories/subscription_repository.dart, List, SubscriptionOverview, clear, currentPlanId, isLoading, isLoadingPlans, load (+6 more)
...
Cohesion: 0.20
Nodes (9): ../../core/theme/app_colors.dart, ../../core/utils/venue_presentation.dart, VoidCallback, build, _GuestVenueCard, onMap, showGuestVenuesSheet, showModalBottomSheet (+1 more)

### Community 117 - "package:supabase_flutter/supabase_flutter.dart"
Cohesion: 0.20
Nodes (8): ../models/subscription.dart, package:supabase_flutter/supabase_flutter.dart, package:weeding_app/app/modules/invitations/entrance_qr_page.dart, _client, getOverview, getPlans, SubscriptionRepository, main
...
### Community 121 - "GetxController"
Cohesion: 0.22
Nodes (8): GetxController, invitations_controller.dart, WeddingThemeController, AdminController, dependencies, InvitationsBinding, InvitationsController, SubscriptionController
...
### Community 128 - "_GuestAccessPageState"
Cohesion: 0.40
Nodes (5): TickerProviderStateMixin, GuestAccessPage, _GuestAccessPageState, MediaPlayerPage, _MediaPlayerPageState

### Community 129 - "package:flutter/material.dart"
Cohesion: 0.50
Nodes (3): package:flutter/material.dart, buildWebAudioRecorderPage, buildWebVideoRecorderPage

### Community 130 - "GetMiddleware"
Cohesion: 0.67
Nodes (3): GetMiddleware, AuthMiddleware, PlatformAdminMiddleware

## Knowledge Gaps
- **1450 isolated node(s):** `name`, `short_name`, `description`, `start_url`, `scope` (+1445 more)
...
- **Why does `AuthController` connect `home_page_layout_test.dart` to `settings_page.dart`, `auth_controller.dart`, `app_binding.dart`, `Bindings`, `../../core/theme/app_text_styles.dart`, `home_page.dart`, `workspace_onboarding_page.dart`, `register_page.dart`, `login_page.dart`, `GetxController`, `app_pages.dart`, `home_controller.dart`, `workspace_onboarding_controller.dart`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `GuestRepository` connect `guest_repository.dart` to `tables_controller.dart`, `table_detail_page.dart`, `guest_access_controller.dart`, `invitations_page.dart`, `invitations_controller.dart`, `guests_controller.dart`, `home_controller.dart`?**

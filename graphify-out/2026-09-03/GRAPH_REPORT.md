...
## Corpus Check
- 198 files · ~521,468 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2263 nodes · 3108 edges · 140 communities (124 shown, 16 thin omitted)
...
Cohesion: 0.06
Nodes (33): ../../data/models/guest_media.dart, ../../data/repositories/media_repository.dart, media_player_page.dart, build, color, count, createState, guest (+25 more)

### Community 10 - "micro_interactions.dart"
Cohesion: 0.06
Nodes (32): _anim, backgroundColor, borderRadius, boxShadow, build, child, createState, _ctrl (+24 more)
...
Cohesion: 0.07
Nodes (27): EdgeInsets, Gradient?, PreferredSizeWidget, Size get, actions, actionText, backgroundColor, bottom (+19 more)
...
Cohesion: 0.05
Nodes (43): _accentController, _backgroundController, bodyFont, build, color, _ColorSlot, controller, createState (+35 more)
...
Cohesion: 0.05
Nodes (39): ../../data/models/guest_link.dart, _AssignSheet, _AssignSheetState, availableChairs, build, _confirmCancellation, _confirmDelete, controller (+31 more)
...
### Community 19 - "State"
Cohesion: 0.10
Nodes (33): _PasswordField, SingleTickerProviderStateMixin, State, StatefulWidget, TickerProviderStateMixin, ScaleIn, _ScaleInState, GradientButton (+25 more)
...
Cohesion: 0.08
Nodes (27): Animation, Duration, TextStyle?, _anim, AnimatedCounter, _AnimatedCounterState, borderRadius, build (+19 more)
...
Cohesion: 0.11
Nodes (19): AnimationController, ../../core/utils/validators.dart, TextEditingController, _bgCtrl, build, _buildInput, _buildLabel, controller (+11 more)
...
Cohesion: 0.08
Nodes (25): ../../core/utils/invitation_sender.dart, ../../core/widgets/shared_components.dart, _avatarColor, build, _buildField, _buildFilterChips, controller, createState (+17 more)
...
Cohesion: 0.15
Nodes (12): ../models/platform_admin.dart, AdminRepository, _client, grantInvitations, isPlatformAdmin, listAccounts, listEvents, listOrganizations (+4 more)
...
Cohesion: 0.11
Nodes (19): StatelessWidget, SectionHeader, StatusBadge, _AudioWaveform, _ControlButton, _FullscreenControlButton, _NotificationToggle, _PaletteDots (+11 more)
...
Cohesion: 0.11
Nodes (17): addressLine, city, countryCode, endsAt, eventId, fromJson, id, instructions (+9 more)
...
Cohesion: 0.11
Nodes (18): TextInputType?, build, _confirmDelete, controller, _EmptyVenues, icon, keyboardType, label (+10 more)
...
Cohesion: 0.09
Nodes (20): auth_controller.dart, Bindings, guest_access_controller.dart, home_controller.dart, package:get/get.dart, venues_controller.dart, AppBinding, AuthBinding (+12 more)
...
Cohesion: 0.18
Nodes (10): ../../core/widgets/micro_interactions.dart, build, child, _pickDate, _SectionCard, stepNumber, _TipCard, title (+2 more)
...
Cohesion: 0.14
Nodes (13): app/bindings/app_binding.dart, app/core/constants/supabase_config.dart, app/core/storage/secure_local_storage.dart, app/core/theme/app_theme.dart, app/core/theme/wedding_theme_controller.dart, app/routes/app_pages.dart, package:flutter_localizations/flutter_localizations.dart, WeddingThemeController (+5 more)
...
Cohesion: 0.18
Nodes (10): ../../core/utils/quota_error.dart, ../../core/widgets/wedding_header.dart, ../../data/repositories/guest_link_repository.dart, package:flutter/services.dart, package:qr_flutter/qr_flutter.dart, ../subscription/subscription_controller.dart, build, _getPublicUrl (+2 more)
...
Cohesion: 0.12
Nodes (16): GetxController, guests_controller.dart, ../modules/admin/admin_controller.dart, ../modules/auth/auth_controller.dart, ../modules/guests/guests_controller.dart, ../modules/home/home_controller.dart, ../modules/invitations/invitations_controller.dart, ../modules/navigation/main_navigation_controller.dart (+8 more)

### Community 104 - "invitation_sender.dart"
Cohesion: 0.10
Nodes (19): ../../data/repositories/wedding_settings_repository.dart, package:share_plus/share_plus.dart, build, _ChannelTile, email, firstName, icon, iconColor (+11 more)

### Community 105 - "plans_page.dart"
Cohesion: 0.14
Nodes (13): subscription_controller.dart, SubscriptionPlan, build, isCurrent, label, plan, _PlanCard, _PlanLine (+5 more)

### Community 106 - "whatsapp_helper.dart"
Cohesion: 0.07
Nodes (26): ../constants/supabase_config.dart, return, bride, buffer, _buildInvitationMessage, couple, date, digits (+18 more)
...
Cohesion: 0.13
Nodes (14): ../../data/models/subscription.dart, ../../data/repositories/subscription_repository.dart, SubscriptionOverview, clear, currentPlanId, isLoading, isLoadingPlans, load (+6 more)
...
### Community 116 - "VoidCallback"
Cohesion: 0.20
Nodes (9): ../../core/utils/venue_presentation.dart, VoidCallback, EventVenue, build, _GuestVenueCard, onMap, showGuestVenuesSheet, showModalBottomSheet (+1 more)
...
### Community 121 - "InvitationsController"
Cohesion: 0.40
Nodes (4): invitations_controller.dart, dependencies, InvitationsBinding, InvitationsController
...
### Community 128 - "../../core/theme/app_colors.dart"
Cohesion: 0.12
Nodes (17): ../auth/auth_controller.dart, ../../core/theme/app_colors.dart, ../../core/theme/app_text_styles.dart, ../../core/widgets/wedding_rings_icon.dart, ../../routes/app_routes.dart, build, createState, initState (+9 more)
...
### Community 131 - "Widget?"
Cohesion: 0.32
Nodes (7): Offset, PageRouteBuilder, T, page, SlideFadeRoute, SlideUpRoute, Widget?

## Knowledge Gaps
- **1478 isolated node(s):** `name`, `short_name`, `description`, `start_url`, `scope` (+1473 more)
...
- **Why does `AuthController` connect `home_page_layout_test.dart` to `../../core/theme/app_colors.dart`, `settings_page.dart`, `auth_controller.dart`, `app_binding.dart`, `package:get/get.dart`, `home_page.dart`, `workspace_onboarding_page.dart`, `register_page.dart`, `login_page.dart`, `home_controller.dart`, `app_pages.dart`, `workspace_onboarding_controller.dart`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `EventVenue` connect `VoidCallback` to `venues_page.dart`, `event_venue.dart`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `Guest` connect `guest.dart` to `guest_detail_page.dart`, `media_player_page.dart`, `invitations_page.dart`, `table_detail_page.dart`?**
